...
export const DATA_SOURCES = [
  ...
  },
  {
    ...
    whatWeFetch: "six years of historical (2019-2024) daily precipitation sums, maximum wind gusts, and precipitation probabilities for the shoot month at exact location coordinates.",
  ...
  },
  {
    ...
    whatWeFetch: "Aggregated empirical cost overruns, delay hours, and continuity scores across 200,000+ disruption records grounded in real public archives (60 filming hubs, Open-Meteo 2019-2024 weather, SAG-AFTRA/IATSE rate cards, IMDb/TheNumbers budget percentiles) via strategy_performance_mv. Synthetic corpus grounded in real archives — see Historical Corpus Provenance.",
    howUsed: "Calibrates bottom-up rate card estimates (0.7 bottom-up + 0.3 historical average) to ground option pricing in realistic, geographically and seasonally grounded empirical evidence. Synthetic corpus grounded in real archives — see Historical Corpus Provenance.",
