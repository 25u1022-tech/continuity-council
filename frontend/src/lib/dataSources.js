...
export const DATA_SOURCES = [
  ...
  },
  {
    ...
    whatWeFetch: "Aggregated empirical cost overruns, delay hours, and continuity scores across 200,000+ disruption records grounded in real public archives (60 filming hubs, Open-Meteo 2019-2024 weather, SAG-AFTRA/IATSE rate cards, IMDb/TMDB budget percentiles) via strategy_performance_mv.",
    howUsed: "Calibrates bottom-up rate card estimates (0.7 bottom-up + 0.3 historical average) to ground option pricing in realistic, geographically and seasonally grounded empirical evidence.",
